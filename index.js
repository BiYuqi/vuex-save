// 本地存储默认名
const SaveVuexStaticName = 'Save_Vuex_Static_Name'
// 默认存储方式
const STATIC_MODE = 'localStorage'

/**
 * @description 存储
 * @param {*} mode 
 */
const setStore = (state, mode) => {
 ...
 */
const getStore = (mode) => {
  const local = window[mode].getItem(SaveVuexStaticName)
